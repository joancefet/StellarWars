...
//----------------------------------------------------------------------------//
// Tutorial
$LNG['tut_welcome']	 						= 'Bem vindo ao Tutorial Stellar Wars';
$LNG['tut_welcom_desc']						= 'Bem-vindo ao Stellar Wars! Você é novo aqui? Este tutorial irá explicar-lhe as principais funções do jogo.';
$LNG['tut_welcom_desc2']	 				= 'Durante o desenvolvimento do jogo você terá várias tarefas para as quais você será recompensado quando concluir com êxito o objetivo.';
$LNG['tut_welcom_desc3']	 				= 'A seqüência dessas tarefas é aleatória. No entanto, como o conteúdo de vários tutoriais são completos uns com os outros, nós recomendamos que você siga uma ordem predeterminada.';
$LNG['tut_welcom_desc4']	 				= 'Para visualizar esta página você deverá clicar em Tutorial no menu esquerdo do jogo.';
$LNG['tut_welcom_desc5']	 				= 'Depois de ter concluído a tarefa irá receber mais informações e a recompensa pelo trabalho.';
$LNG['tut_objects']							= 'Tarefas';
$LNG['tut_go']	 							= 'Iniciar!';
$LNG['tut_go_to']	 						= 'Ir';
$LNG['tut_m1']	 							= 'Tarefa 1';
$LNG['tut_m2']	 							= 'Tarefa 2';
...
$LNG['tut_m8']	 							= 'Tarefa 8';
$LNG['tut_m9']	 							= 'Tarefa 9';
$LNG['tut_ready']	 						= '<font color="#00FF00">Completo</font>';
$LNG['tut_not_ready']						= '<font color="red">Incompleto</font>';
$LNG['tut_m1_name']	 						= 'Tarefa 1 - Fornecimento básico';
$LNG['tut_m1_desc']	 						= 'Para expandir o seu planeta você em primeiro lugar, deverá ter recursos suficientes. Você pode produzir esses recursos usando minas. Garantir o seu abastecimento básico, expandindo o seu metal e minas de cristal. Por favor, note que a manutenção dos edifícios de fornecimento usa uma grande quantidade de energia. Você pode produzir essa energia, por exemplo, usando plantas de energia solar.';
$LNG['tut_m1_quest']	 					= 'Atualizar mina de metal para level 4';
$LNG['tut_m1_quest2']	 					= 'Atualizar mina de cristal para level 2';
$LNG['tut_m1_quest3']	 					= 'Atualizar planta de energia solar para level 4';
$LNG['tut_m1_quest4']	 					= 'free';
$LNG['tut_m1_quest5']	 					= 'free';
$LNG['tut_m1_gain']	 						= '<font color="orange">Recompensa : 200 de Matéria Negra</font>';
$LNG['tut_m1_ready']	 					= 'Você conseguiu completar a missão! Recompensa: 200 Matéria Negra';
$LNG['tut_m2_name']	 						= 'Tarefa 2 - Defendendo o planeta';
$LNG['tut_m2_desc']	 						= 'Para proteger os seus recursos de saqueadores inimigos, você deve pensar sobre a expansão de instalações de sua defesas no início. Você pode, por exemplo, ler sobre o que você precisa para construir um lançador de mísseis em Sistemas de defesa, clicando em Tecnologia, no menu esquerdo do jogo. Você precisa de deutério para expandir suas instalações de defesa. Portanto, você deve estabelecer uma produção básica deste recurso primeiro.';
$LNG['tut_m2_quest']	 					= 'Atualizar o extrator de deutério para level 2';
$LNG['tut_m2_quest2']						= 'Construir Fábrica de robots level 2';
$LNG['tut_m2_quest3']	 					= 'Construir um Hangar level 1';
$LNG['tut_m2_quest4']	 					= 'Construir um Lançador de mísseis';
$LNG['tut_m2_quest5']	 					= 'free';
$LNG['tut_m2_gain']	 						= '<font color="orange">Recompensa : 200 de Matéria Negra</font>';
$LNG['tut_m2_ready']	 					= 'Você conseguiu completar a missão! Recompensa: 200 Matéria Negra';
$LNG['tut_m3_name']	 						= 'Tarefa 3 - Fornecimento do planeta';
$LNG['tut_m3_desc']	 						= 'Após as bases para o fornecimento tenham sido estabelecidas, você deve intensificá-las. Por favor, certifique-se que sempre haja energia suficiente disponível.';
$LNG['tut_m3_quest']	 					= 'Atualizar mina de metal para level 10';
$LNG['tut_m3_quest2']	 					= 'Atualizar mina de cristal para level 7';
$LNG['tut_m3_quest3']	 					= 'Atualizar extrator de deutério para level 5';
$LNG['tut_m3_quest4']						= 'free';
$LNG['tut_m3_quest5']						= 'free';
$LNG['tut_m3_gain']	 						= '<font color="orange">Recompensa : 200 de Matéria Negra</font>';
$LNG['tut_m3_ready']	 					= 'Você conseguiu completar a missão! Recompensa: 200 Matéria Negra';
$LNG['tut_m4_name']	 						= 'Tarefa 4 - A primeira nave';
$LNG['tut_m4_desc']	 						= 'Naves, bem como lançadores de mísseis podem protegê-lo dos inimigos. Elas têm a vantagem de que podem ainda ser utilizadas para fins ofensivos. Contudo, as naves e instalações modernas de defesa tem que ser pesquisadas em primeiro lugar. Você vai precisar de um laboratório de pesquisa para fazer isso.';
$LNG['tut_m4_quest']	 					= 'Construir um Laboratório de pesquisas level 1';
$LNG['tut_m4_quest2']	 					= 'Atualizar seu Hangar para level 2';
$LNG['tut_m4_quest3']	 					= 'Pesquisar Motor de combustão level 2';
$LNG['tut_m4_quest4']	 					= 'Construir um Cargueiro pequeno';
$LNG['tut_m4_quest5']	 					= 'free';
$LNG['tut_m4_gain']	 						= '<font color="orange">Recompensa : 200 de Matéria Negra</font>';
$LNG['tut_m4_ready']	 					= 'Você conseguiu completar a missão! Recompensa: 200 Matéria Negra';
$LNG['tut_m5_name']	 						= 'Tarefa 5 - Redes de informação';
$LNG['tut_m5_desc']	 						= 'Você não está sozinho no universo! Informações e redes de contatos são muito importantes. Aqueles que socializarem podem contar com a ajuda de outros jogadores e podem encontrar parceiros comerciais mais facilmente. Um monte de jogadores se organizam em alianças para alcançar os seus objetivos em conjunto.';
$LNG['tut_m5_quest']	 					= 'Tornar-se membro de uma aliança';
$LNG['tut_m5_quest2']	 					= 'Criar uma requisição de amizade';
$LNG['tut_m5_quest3']	 					= 'free';
$LNG['tut_m5_quest4']	 					= 'free';
$LNG['tut_m5_quest5']	 					= 'free';
$LNG['tut_m5_gain']							= '<font color="orange">Recompensa : 200 de Matéria Negra</font>';
$LNG['tut_m5_ready']	 					= 'Você conseguiu completar a missão! Recompensa: 200 Matéria Negra';
$LNG['tut_m6_name']	 						= 'Tarefa 6 - Negociando';
$LNG['tut_m6_desc']	 						= 'O Mercador é um recurso premium com o qual você pode trocar um recurso por meio de uma taxa de câmbio configurada pelo sistema por outros recursos. A produção máxima possível de recursos é limitada ao montante dos seus recursos e a carga máxima de sua capacidade de armazenamento. Quando seu sistema de armazenagem lotar pela primeira vez, às vezes é melhor negociar com o Mercador do que construir mais armazenagem.';
$LNG['tut_m6_quest']	 					= 'Construir um armazém de recursos de sua escolha level 1';
$LNG['tut_m6_quest2']	 					= 'Fazer uma negociação qualquer usando o Mercador';
$LNG['tut_m6_quest3']	 					= 'free';
$LNG['tut_m6_quest4']	 					= 'free';
$LNG['tut_m6_quest5']	 					= 'free';
$LNG['tut_m6_gain']	 						= '<font color="orange">Recompensa : 200 de Matéria Negra</font>';
$LNG['tut_m6_ready']	 					= 'Você conseguiu completar a missão! Recompensa: 200 Matéria Negra';
$LNG['tut_m7_name']	 						= 'Tarefa 7 - Ações de frotas';
$LNG['tut_m7_desc']	 						= 'Outra maneira de se conseguir recursos é atacar planetas inimigos. No entanto, cuidado que alguns planetas são muito bem protegidos. Para saber informações sobre planetas estrangeiros, você pode espiá-los. <br /><font color="yellow">Para completar esta tarefa, envie sua sonda de espionagem em missão de espionagem a partir do menu de frotas. NÃO use o atalho da página de galáxias para completar esta tarefa.</font>';
$LNG['tut_m7_quest']						= 'Contruir uma Sonda de espionagem';
$LNG['tut_m7_quest2']	 					= 'Espionar um planeta de outro jogador';
$LNG['tut_m7_quest3']	 					= 'free';
$LNG['tut_m7_quest4']	 					= 'free';
$LNG['tut_m7_quest5']	 					= 'free';
$LNG['tut_m7_gain']	 						= '<font color="orange">Recompensa : 200 de Matéria Negra</font>';
$LNG['tut_m7_ready']	 					= 'Você conseguiu completar a missão! Recompensa: 200 Matéria Negra';
$LNG['tut_m8_name']	 						= 'Tarefa 8 - Expandindo seu império';
$LNG['tut_m8_desc']	 						= 'Um imperador está sempre ansioso para expandir seu império. Você já estabeleceu as bases em seu planeta natal, mas em algum momento ele vai ser completamente expandido. Desenvolver novos planetas no início, para se apossar dos recursos mais rapidamente e se apossar de espaços para novos edifícios. Através do tráfego aéreo flexível entre os planetas, você também tem um poderoso dispositivo para proteger seus recursos de ataques inimigos.';
$LNG['tut_m8_quest']	 					= 'Criar uma nova Colônia';
$LNG['tut_m8_quest2']	 					= 'free';
$LNG['tut_m8_quest3']	 					= 'free';
$LNG['tut_m8_quest4']	 					= 'free';
$LNG['tut_m8_quest5']	 					= 'free';
$LNG['tut_m8_gain']	 						= '<font color="orange">Recompensa : 1000 de Matéria Negra</font>';
$LNG['tut_m8_ready']	 					= 'Você conseguiu completar a missão! Recompensa: 1000 Matéria Negra';
$LNG['tut_m9_name']	 						= 'Tarefa 9 - Campos de destroços';
$LNG['tut_m9_desc']	 						= 'Depois de lutar em Orbita, campos de detritos são formadas a partir de metal e cristal dos resíduos de navios destruídos. A decomposição dos escombros oferece-lhe um importante método alternativo de ganhar recursos.';
$LNG['tut_m9_quest']	 					= 'Construir um Reciclador';
$LNG['tut_m9_quest2']	 					= 'Reciclar em um campo de destroços';
$LNG['tut_m9_quest3']	 					= 'free';
$LNG['tut_m9_quest4']	 					= 'free';
$LNG['tut_m9_quest5']	 					= 'free';
$LNG['tut_m9_gain']	 						= '<font color="orange">Recompensa : 2000 de Matéria Negra</font>';
$LNG['tut_m9_ready']	 					= 'Você conseguiu completar a missão! Recompensa: 2000 Matéria Negra';
$LNG['tut_compleat']						= 'Você conseguiu completar o tutorial!';
//----------------------------------------------------------------------------//

//###########################################################//
//limitador de ataques
$LNG['bashing']						= 'Você já atacou este jogador 6 vezes ou mais nas últimas 24 horas. Deixe o pobre coitado descansar um pouco e tente atacá-lo novamente mais tarde.';
$LNG['allyigual']					= 'Você não pode atacar um membro da mesma aliança que a sua.';

//Federação
$LNG['federacao_help_sucess']			= 'A Federação aceitou sua solicitação de ajuda e imediatamente mobiliza suas tropas para protege-lo. Aguarde até que as tropas da Federação cheguem ao seu planeta. Após chegarem, você estará protegido por 24 horas. Boa sorte!';
$LNG['federacao_help_fail']			= 'A Federação rejeitou sua solicitação de ajuda. Por favor verifique novamente os requerimentos necessários para se obter auxílio da Federação.';
$LNG['federacao_help_fail2']			= 'Você não pode solicitar ajuda da Federação estando em uma Lua, por favor, dirija-se a um planeta seu e solicite ajuda novamente.';
$LNG['federacao_help_fail3']			= 'Você solicitou ajuda da Federação nos últimos 5 dias(120 horas) e foi atendido, portanto, a Federação entende que por hora, já fez sua parte. Tente novamente mais tarde.';
$LNG['federacao_help_fail4']			= 'A Federação já possuí uma frota encaminhada em direção ao seu planeta para ajudá-lo, por favor aguarde.';
$LNG['fs_req1']					= 'Ter sofrido 10 ou mais ataques nas últimas 24 horas.';
